...
oapi-codegen -config oapi-codegen-config.yaml -generate embedded-spec -package api -o internal/adapters/api/spec.gen.go palaestra-api-v1.yml

# Generate client code (optional)
echo "Generating client code..."
oapi-codegen -config oapi-codegen-config.yaml -generate client -package client -o internal/adapters/client/client.gen.go palaestra-api-v1.yml
